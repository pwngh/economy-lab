 ...
 * here matters only when a handler is called directly, such as from a test. It fails loudly rather
 * than quietly write a privileged change under the wrong actor.
 */
