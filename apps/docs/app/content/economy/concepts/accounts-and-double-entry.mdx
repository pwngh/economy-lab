...
A balance you can edit is a balance you can't trust. So balances aren't stored and mutated in place. They're _derived_. The ledger is an append-only book of postings, and an account's balance is the running sum of its lines.
