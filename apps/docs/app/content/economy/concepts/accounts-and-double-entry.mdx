...
order: 30
status: stable
sourceRefs: ["src/accounts.ts#L59", "src/ledger.ts#L100", "src/pricing.ts#L51 · splitLegs"]
related: ["economy/concepts/actors-and-authorization", "economy/reference/outcomes-and-reason-codes"]
---
