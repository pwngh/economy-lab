...
order: 90
status: stable
sourceRefs: ["src/ledger.ts#L65 · lockAll", "src/economy.ts#L557 · lockAccounts", "src/engines/postgres.ts#L305 · advanceChain", "db/postgresql-schema.sql#L105 · chain_links_account_prev_uq"]
