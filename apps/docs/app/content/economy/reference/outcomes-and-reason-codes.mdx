...
window, the `limit`, the `windowMs`, and `retryAfter` — when the oldest counted attempt
ages out of the [velocity window](/economy/concepts/spend-velocity/).
