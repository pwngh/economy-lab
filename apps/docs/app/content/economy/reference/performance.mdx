...
order: 45
status: stable
sourceRefs: ["scripts/bench.ts#L64 · BASE_ENV", "scripts/bench.ts#L79 · CURVE_SIZES", "src/chain.ts#L122 · proveChain", "src/worker/checkpoint.ts#L57 · sealCheckpoint"]
...
Read these as *relative cost and scaling shape*, not as a capacity figure. A single sequential process on one machine doesn't tell you production throughput; it tells you how the backends compare and how the curves bend as the ledger grows.
</Callout>
