...
order: 10
status: stable
sourceRefs: ["src/operations/topUp.ts#L37 · topUp", "src/operations/registry.ts#L45 · REGISTRY", "src/contract.ts#L68 · kind 'topUp'", "src/webhooks.ts#L136 · toTopUp"]
related: ["economy/reference/operations/spend", "economy/reference/operations/refund", "economy/reference/configuration"]
---
...
<Callout type="note">
  The CREDIT `REVENUE` account is untouched by a top-up, so it keeps meaning transaction fees only.
  The newly issued credits offset against `STORED_VALUE`, not `REVENUE`. The external app-store cut
  and VAT happen at the cash-in rail before this ledger sees the purchase, and aren't modelled.
</Callout>
