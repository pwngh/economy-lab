...
This is the request-path half of [idempotency](/economy/concepts/integrity/): the replay store drops most redeliveries here, at the edge, before they reach the handler.
