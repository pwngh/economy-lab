...
| `PAYOUT_MIN_INTERVAL_MS`  | Minimum time between a user's payout requests. The 24h default matches the creator docs of the real platform the example models; that platform's payout terms require 14 days, so a production deploy sets `1209600000`. | `86400000` (24h)   |
