...
sourceRefs:
  [
    'src/ports.ts#L360 · Store',
    'src/ports.ts#L245 · Ledger',
    'src/adapters/memory.ts#L1389 · memoryStore',
    'src/engines/postgres.ts#L1826 · postgresStore',
  ]
