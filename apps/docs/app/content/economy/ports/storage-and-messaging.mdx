...
sourceRefs:
  [
    ...
    'src/ports.ts#L206 · Ledger',
    'src/adapters/memory.ts#L1167 · memoryStore',
    'src/engines/postgres.ts#L1579 · postgresStore',
    'src/worker/relay.ts#L55 · relayOutbox',
  ]
