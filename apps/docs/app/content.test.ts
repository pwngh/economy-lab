...
// The slug contract: economy-lab's source links here via @see {DOCS_BASE_URL}/<slug>,
// section-rooted under economy/. Every one must resolve, or an inbound link dangles.
const CONTRACT = [
  ...[
    'overview',
    'money-model',
