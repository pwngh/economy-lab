...
export default function ReferenceIndex() {
  const pages = docs
    .filter(
      (d) =>
        d.section === 'reference' &&
        !d.slug.startsWith('economy/reference/operations/'),
    )
    .map((d) => d.slug);
  ...
  return (
    <section className="prose">
      ...
      <p className="doc-summary">
        The exhaustive surface: what each call does, what it returns, and how it
        is configured.
      </p>

      <h2>Operations</h2>
      <p>
        Every state-changing call is one <code>Operation</code>, submitted
